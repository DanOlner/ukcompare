...
## Wholesale trade, Sheffield vs Barnsley / Doncaster / Rotherham GVA change 

Wholesale trade's GVA per worker is increasing everywhere, as well as increasing in its proportion of overall GVA. Barnsley, Doncaster & Rotherham are quite a bit larger than Sheffield for this sector (though both some way from places with the largest % of their GVA from this sector).

```{r, fig.width=10, fig.height=6}
sector <- itl3.cp$SIC07_description[grepl('wholesale trade', itl3.cp$SIC07_description ,ignore.case = T)] %>% unique
...
Barnsley / Doncaster / Rotherham are some way larger in specialised construction activities than Sheffield, and close to being in the top group of ITL3 areas for % GVA in this (mostly non-tradeable) sector.
