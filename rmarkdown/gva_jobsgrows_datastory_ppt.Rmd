...
# South Yorkshire vs UK 08 to 21, SY growth, shrinkage elsewhere
...
# South Yorkshire LQ > 1 in 2021, vs WY, LCR & GM, LQ trends for whole timerange, non-sig trends removed


```{r SY_v_3places_LQplot_se}
#Use
#LQ_slopes %>% filter(slope==0)
#To see which didn't get slopes (only 8 rows in the current data)
...
# Manufacture of basic metals GVA %, SY vs top %s in 2021, 3 yr movin av
...
# Health GVA %, SY vs top %s in 2021, 3 yr movin av
...
# Motor trades GVA %, SY vs top %s in 2021, 3 yr movin av
